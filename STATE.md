...
- [rustjava-upstream-sync-cadence-decision] ★★**upstream 동기 «정기 축» 판정 — 결론: ⒝ 격차 기반 `behind ≥ 20`.**
  ...
  ★★**제안의 전제(「벌어진 뒤에 받으면 훨씬 비싸다」)를 «먼저 재서» 반증했다**: 회차 커밋 수 ↔ 새 충돌
  ★**r = −0.169**(사실상 0 · 부호 음) — 커밋 많은 4회차(**37커밋**) 충돌 **11** ↔ 적은 4회차(**8커밋**) 충돌 **17**.
  ...
  ★**사건 기반 기각**: S3 충돌 9건은 upstream **«신규» 파일**에서, S8 8건은 **전 트리 개명**에서 왔다 ⇒ 경로 트리거가 대부분을 놓친다.
