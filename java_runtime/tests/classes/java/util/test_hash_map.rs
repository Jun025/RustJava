...
async fn test_hash_map_basic_put_get_overwrite_and_remove() -> Result<()> {
    ...
    let size: i32 = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "size", "()I", ())
        .await?;
    assert_eq!(size, 0);
    let is_empty: bool = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "isEmpty", "()Z", ())
        .await?;
    assert!(is_empty);
...
async fn test_hash_map_clear_removes_entries_and_bucket_chains() -> Result<()> {
    ...
    let _: () = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "clear", "()V", ())
        .await?;
...
async fn test_hash_map_entry_direct_methods_and_assignability() -> Result<()> {
    ...
    let found_key: ClassInstanceRef<Object> = jvm
        .invoke_virtual(&entry, "java/util/HashMap$Entry", "getKey", "()Ljava/lang/Object;", ())
        .await?;
    assert_eq!(JavaLangString::to_rust_string(&jvm, &found_key).await?, "entry-key");

    let found_value: ClassInstanceRef<Object> = jvm
        .invoke_virtual(&entry, "java/util/HashMap$Entry", "getValue", "()Ljava/lang/Object;", ())
        .await?;
...
async fn test_hash_map_key_set_view_backing_and_iterator_snapshot() -> Result<()> {
    ...
    let key_set: ClassInstanceRef<Object> = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "keySet", "()Ljava/util/Set;", ())
        .await?;
    ...
    let size: i32 = jvm
        .invoke_virtual(&key_set, &key_set.class_definition().name(), "size", "()I", ())
        .await?;
    assert_eq!(size, 2);
    let contains: bool = jvm
        .invoke_virtual(
            &key_set,
            &key_set.class_definition().name(),
            "contains",
            "(Ljava/lang/Object;)Z",
            (first_key.clone(),),
        )
    ...
    let key_array: ClassInstanceRef<Array<Object>> = jvm
    ...
    let iterator: ClassInstanceRef<Object> = jvm
        .invoke_virtual(&key_set, &key_set.class_definition().name(), "iterator", "()Ljava/util/Iterator;", ())
        .await?;
    ...
    let _: () = jvm
        .invoke_virtual(&key_set, &key_set.class_definition().name(), "clear", "()V", ())
        .await?;
    let size: i32 = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "size", "()I", ())
        .await?;
    assert_eq!(size, 0);
    let is_empty: bool = jvm
        .invoke_virtual(&key_set, &key_set.class_definition().name(), "isEmpty", "()Z", ())
        .await?;
    assert!(is_empty);
...
async fn test_hash_map_values_view_contains_clear_and_iterator_snapshot() -> Result<()> {
    ...
    let values: ClassInstanceRef<Object> = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "values", "()Ljava/util/Collection;", ())
        .await?;
    ...
    let size: i32 = jvm.invoke_virtual(&values, &values.class_definition().name(), "size", "()I", ()).await?;
    assert_eq!(size, 2);
    ...
    let contains_equal: bool = jvm
        .invoke_virtual(
            ...
            "contains",
            "(Ljava/lang/Object;)Z",
            (equal_value_distinct.clone(),),
        )
        .await?;
    assert!(contains_equal);
    let contains_missing: bool = jvm
        .invoke_virtual(
            &values,
            &values.class_definition().name(),
            "contains",
    ...
    let values_array: ClassInstanceRef<Array<Object>> = jvm
        .invoke_virtual(&values, &values.class_definition().name(), "toArray", "()[Ljava/lang/Object;", ())
        .await?;
    ...
    let iterator: ClassInstanceRef<Object> = jvm
        .invoke_virtual(&values, &values.class_definition().name(), "iterator", "()Ljava/util/Iterator;", ())
        .await?;
    ...
    let _: () = jvm.invoke_virtual(&values, &values.class_definition().name(), "clear", "()V", ()).await?;
    let size: i32 = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "size", "()I", ())
        .await?;
    assert_eq!(size, 0);
    let is_empty: bool = jvm
        .invoke_virtual(&values, &values.class_definition().name(), "isEmpty", "()Z", ())
        .await?;
    assert!(is_empty);
...
async fn test_hash_map_entry_set_view_backing_clear_and_iterator_snapshot() -> Result<()> {
    ...
    let entry_set: ClassInstanceRef<Object> = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "entrySet", "()Ljava/util/Set;", ())
        .await?;
    ...
    let size: i32 = jvm
        .invoke_virtual(&entry_set, &entry_set.class_definition().name(), "size", "()I", ())
        .await?;
    assert_eq!(size, 2);
    let is_empty: bool = jvm
        .invoke_virtual(&entry_set, &entry_set.class_definition().name(), "isEmpty", "()Z", ())
        .await?;
    assert!(!is_empty);
    ...
    let _: () = jvm
        .invoke_virtual(&entry_set, &entry_set.class_definition().name(), "clear", "()V", ())
        .await?;
    let size: i32 = jvm
        .invoke_virtual(&hash_map, &hash_map.class_definition().name(), "size", "()I", ())
        .await?;
...
async fn test_hash_map_entry_set_contains_candidates_and_null_values() -> Result<()> {
    ...
    let contains: bool = jvm
        .invoke_virtual(
            &entry_set,
            &entry_set.class_definition().name(),
            "contains",
            "(Ljava/lang/Object;)Z",
            (backing_entry.clone(),),
        )
    ...
    let contains: bool = jvm
        .invoke_virtual(
            ...
            "contains",
            "(Ljava/lang/Object;)Z",
            (candidate_null_for_non_null_value,),
        )
        .await?;
    assert!(!contains);
