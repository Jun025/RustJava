...
use rustjava_runtime::classes::java::io::{InputStream, OutputStream, Writer};
...
async fn bio_06_bio_07_buffered_writer_contract() -> Result<()> {
    ...
    let _: () = jvm
        ...
        .await?;
    let actual: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
        .invoke_virtual(
            &default_output,
    ...
    let _: () = jvm
        ...
        .await?;
    let value: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = jvm
    ...
    assert!(jvm.is_instance(&*exception, "java/io/IOException"));
    let null_string: ClassInstanceRef<rustjava_runtime::classes::java::lang::String> = None.into();
    let closed: Result<()> = jvm
        .invoke_virtual(
            &writer,
            &writer.class_definition().name(),
