...
impl OverridePrintWriter {
    ...
    async fn print_int(jvm: &Jvm, _: &mut RuntimeContext, this: ClassInstanceRef<Self>, value: i32) -> Result<()> {
        ...
        jvm.invoke_virtual(&this, "OverridePrintWriter", "write", "(Ljava/lang/String;)V", (value,))
            .await
    }
...
async fn pw_01_constructors_fields_descriptors_and_access_flags() -> Result<()> {
    ...
    let _: () = jvm
        .invoke_virtual(
            ...
            &default_output_writer.class_definition().name(),
            "write",
            "(Ljava/lang/String;)V",
            (output_text,),
        )
    ...
    let _: () = jvm
        ...
        .await?;
    let output_bytes: ClassInstanceRef<Array<i8>> = jvm
...
async fn pw_02_write_overloads_suppress_only_ioexception() -> Result<()> {
    ...
    let _: () = jvm.invoke_virtual(&writer, "java/io/Writer", "write", "(I)V", ('A' as i32,)).await?;
    let mut chars = jvm.instantiate_array("C", 3).await?;
    jvm.store_array(&mut chars, 0, ['B' as JavaChar, 'C' as JavaChar, 'D' as JavaChar])
        .await?;
    let _: () = jvm.invoke_virtual(&writer, "java/io/Writer", "write", "([C)V", (chars.clone(),)).await?;
    let _: () = jvm
        .invoke_virtual(&writer, "java/io/Writer", "write", "([CII)V", (chars.clone(), 1, 1))
        .await?;
    let text = JavaLangString::from_rust_string(&jvm, "EFG").await?;
    let _: () = jvm
        .invoke_virtual(&writer, "java/io/Writer", "write", "(Ljava/lang/String;)V", (text.clone(),))
        .await?;
    let _: () = jvm
        .invoke_virtual(&writer, "java/io/Writer", "write", "(Ljava/lang/String;II)V", (text.clone(), 1, 1))
        .await?;
    ...
    let invalid_string: Result<()> = jvm
        .invoke_virtual(&writer, "java/io/Writer", "write", "(Ljava/lang/String;II)V", (text, 2, 2))
        .await;
    ...
    let null_string_result: Result<()> = jvm
        .invoke_virtual(&writer, "java/io/Writer", "write", "(Ljava/lang/String;)V", (null_string,))
        .await;
    ...
    let propagating = jvm
        ...
        .await?;
    let runtime_result: Result<()> = jvm
        .invoke_virtual(&propagating, &propagating.class_definition().name(), "write", "(I)V", ('x' as i32,))
        .await;
...
async fn pw_03_print_overloads_follow_string_value_of_and_null_rules() -> Result<()> {
    ...
    let _: () = jvm.invoke_virtual(&writer, "java/io/PrintWriter", "print", "(Z)V", (true,)).await?;
    let _: () = jvm
        .invoke_virtual(&writer, "java/io/PrintWriter", "print", "(C)V", ('|' as JavaChar,))
        .await?;
    let _: () = jvm.invoke_virtual(&writer, "java/io/PrintWriter", "print", "(I)V", (-2,)).await?;
    let _: () = jvm.invoke_virtual(&writer, "java/io/PrintWriter", "print", "(J)V", (3i64,)).await?;
    let _: () = jvm.invoke_virtual(&writer, "java/io/PrintWriter", "print", "(F)V", (1.5f32,)).await?;
    let _: () = jvm
        .invoke_virtual(&writer, "java/io/PrintWriter", "print", "(D)V", (f64::INFINITY,))
        .await?;
    let mut chars = jvm.instantiate_array("C", 2).await?;
    jvm.store_array(&mut chars, 0, ['X' as JavaChar, 'Y' as JavaChar]).await?;
    let _: () = jvm.invoke_virtual(&writer, "java/io/PrintWriter", "print", "([C)V", (chars,)).await?;

    let null_string: ClassInstanceRef<String> = None.into();
    let _: () = jvm
        .invoke_virtual(&writer, "java/io/PrintWriter", "print", "(Ljava/lang/String;)V", (null_string,))
        .await?;
    let object_string = JavaLangString::from_rust_string(&jvm, "obj").await?;
    let object: ClassInstanceRef<Object> = object_string.into();
    let _: () = jvm
        .invoke_virtual(&writer, "java/io/PrintWriter", "print", "(Ljava/lang/Object;)V", (object,))
        .await?;
    let null_object: ClassInstanceRef<Object> = None.into();
    let _: () = jvm
        .invoke_virtual(&writer, "java/io/PrintWriter", "print", "(Ljava/lang/Object;)V", (null_object,))
        .await?;
...
async fn pw_04_println_uses_line_separator_and_is_the_only_autoflush_path() -> Result<()> {
    ...
    let _: () = jvm
        .invoke_virtual(
            &newline_failure_writer,
            &newline_failure_writer.class_definition().name(),
            "println",
            "()V",
            (),
        )
    ...
    let fallback_writer = fallback_jvm
        ...
        .await?;
    let _: () = fallback_jvm
        .invoke_virtual(&fallback_writer, &fallback_writer.class_definition().name(), "println", "()V", ())
        .await?;
    let fallback: ClassInstanceRef<String> = fallback_jvm
        .invoke_virtual(
            &fallback_output,
            &fallback_output.class_definition().name(),
            "toString",
            "()Ljava/lang/String;",
            (),
        )
...
async fn pw_04_println_is_atomic_and_uses_java_virtual_dispatch() -> Result<()> {
    ...
    let _: () = jvm
        .invoke_virtual(&first_close_thread, &first_close_thread.class_definition().name(), "start", "()V", ())
        .await?;
    ...
    let _: () = jvm
        .invoke_virtual(&second_close_thread, &second_close_thread.class_definition().name(), "start", "()V", ())
        .await?;
...
async fn pw_05_flush_close_and_check_error_preserve_trouble_state() -> Result<()> {
    ...
    assert!(
        jvm.invoke_virtual::<_, bool>(&outer_writer, &outer_writer.class_definition().name(), "checkError", "()Z", ())
            .await?
    );
    ...
    let closed_writer = jvm
        ...
        .await?;
    let _: () = jvm
        .invoke_virtual(&closed_writer, &closed_writer.class_definition().name(), "close", "()V", ())
        .await?;
    let _: () = jvm
        .invoke_virtual(&closed_writer, &closed_writer.class_definition().name(), "write", "(I)V", ('x' as i32,))
        .await?;
    let _: () = jvm
        .invoke_virtual(&closed_writer, &closed_writer.class_definition().name(), "flush", "()V", ())
        .await?;
    assert!(
    ...
    let runtime_flush_writer = jvm
        ...
        .await?;
    let runtime_flush_result: Result<()> = jvm
        .invoke_virtual(&runtime_flush_writer, &runtime_flush_writer.class_definition().name(), "flush", "()V", ())
        .await;
    ...
    let runtime_close_writer = jvm
        ...
        .await?;
    let runtime_close_result: Result<()> = jvm
